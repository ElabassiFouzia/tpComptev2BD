...
//}
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       ...
       int res= compteService.crediter(jTextField1.getText(), new Double(jTextField1.getText()));
       if(res>0)
       {JOptionPane.showMessageDialog(null,"COMPTE AJOUTER AVEC SUCCES","INFO",JOptionPane.INFORMATION_MESSAGE);}
       else { JOptionPane.showMessageDialog(null,"ERROOOOOOOR","EROR",JOptionPane.ERROR_MESSAGE);
